...
<%@ page import="uk.ac.ncl.csc3422.kennelbooking.Pen" %>
...
<div class="container">
    ...
    <p><i class="fa fa-clock-o" aria-hidden="true"></i> Current time at D-Dawg kennels: <strong><%= new Date() %></strong></p>
    ...
    <table class="table table-striped" style="max-width: 600px;">
        ...
        <tr>
            <td><%=((List<String>)request.getAttribute("availablePenNames")).get(i)%></td>
        </tr>
        <% } %>
    ...
    <form action="#" method="POST" style="max-width: 320px;">
        ...
        <button type="submit" class="btn-success btn"><i class="fa fa-paw" aria-hidden="true"></i> Submit</button><br>
    </form>
